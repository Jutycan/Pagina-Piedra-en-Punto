...
$jefa_email = "daniflorescasares@gmail.com"; // Email de la jefa para recibir notificaciones
...
try {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'daniflorescasares@gmail.com';
    $mail->Password = 'wnmojzqcxxtwcnxf'; // 16 dígitos de Google
    $mail->SMTPSecure = 'tls';
    $mail->Port = 587;
    $mail->CharSet = 'UTF-8';
